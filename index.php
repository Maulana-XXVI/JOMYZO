...
<head>
    ...
    <link rel="shortcut icon" href="images/logoCRUD.png">
...
<body class="theme-teal">
    ...
    <!-- #END# Search Bar -->
    <!-- Top Bar -->
    <nav class="navbar bg-colorhunt1">
        <div class="container-fluid">
            <div class="navbar-header">
                <a href="javascript:void(0);" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar-collapse" aria-expanded="false"></a>
                <a href="javascript:void(0);" class="bars"></a>
                <a class="navbar-brand" allignment="center" href="index.php">JOMYZO</a>
</div>
            </div>
        </div>
    </nav>
    ...
    height: 135px; }
            ...
            <div class="user-info">
                <div class="image">
                    <img src="images/.png" width="65" height="65" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" style="font-size:20px;" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Admin</div>
            ...
            <div class="menu">
                <ul class="list">
                    <li class="header" style="border-color:#ADDDD0;">MAIN NAVIGATION</li>
                    <li class="nav-item">
                        <a href="index.php">
                        <iconify-icon icon="bxs:home-alt-2"  style="font-size:20px;margin-top: 10px;"></iconify-icon>
                        <span style="margin-top:11px;">Dashboard</span>
                        </a>
                    </li>

                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                        <iconify-icon icon="ic:round-library-books" style="font-size:20px;margin-top: 10px;"></iconify-icon>
                            <span  style="margin-top:11px;">Master Data</span>
                        </a>
                        <ul class="ml-menu">
                            <li>
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                        <iconify-icon icon="iconoir:home-sale" style="font-size:20px;margin-top: 10px;"></iconify-icon>
                            <span style="margin-top:11px;">Penjualan</span>
                        </a>
                        <ul class="ml-menu">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle">
                        <iconify-icon icon="bxs:purchase-tag" style="font-size:20px;margin-top: 10px;"></iconify-icon>
                            <span  style="margin-top:11px;">Pembelian</span>
                        </a>
                        <ul class="ml-menu">
                            <li>
            ...
            <!-- #Menu -->
            <!-- Footer -->
            <div class="legal bg-colorhunt2">
                <div class="copyright">
                <?php echo tgl_indo(date('Y-m-d')); ?> | Repost by KELOMPOK 10
